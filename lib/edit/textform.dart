          ...
          children: [
            ...
            SizedBox(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value!.length <= 74) {
                    return ("provide more details (atleast 75 character)");
                  }
                  return null;
                },
                onSaved: (newValue) => widget.cont2.text = newValue!,
                decoration: InputDecoration(
            ...
            SizedBox(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value!.length <= 49) {
                    return ("provide more details (atleast 50 character)");
                  }
                  return null;
                },
                onSaved: (newValue) => widget.cont4.text = newValue!,
                decoration: InputDecoration(
                  hintText:
            ...
            SizedBox(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value!.length <= 119) {
                    return ("provide more description (atleast 120 character)");
                  }
                  return null;
                },
